                ...
                return GestureDetector(
                  onTap: () {
                    ...
                    final screenMap = <String, Widget>{
                      '/isi_macam_haji/macam_macam_haji': MacamMacamHajiScreen(
                        isDark: isDark,
                      ),
                      '/isi_macam_haji/perbedaan_jenis_haji':
                          PerbedaanJenisHajiScreen(isDark: isDark),
                      '/isi_macam_haji/urutan_umum_haji': UrutanUmumHajiScreen(
                        isDark: isDark,
                      ),
                      '/isi_macam_haji/mengikuti_urutan': MengikutiUrutanScreen(
                        isDark: isDark,
                      ),
                    };
