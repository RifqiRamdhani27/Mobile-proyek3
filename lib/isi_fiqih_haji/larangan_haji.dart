...
import '/isi_fiqih_haji/isi_larangan_haji/larangan_saat_haji.dart';
import '/isi_fiqih_haji/isi_larangan_haji/kesalahan_umum_jamaah.dart';
import '/isi_fiqih_haji/isi_larangan_haji/hikmah_haji.dart';

final List<Map<String, String>> laranganHajiMenuItems = [
  {
...
class LaranganHajiScreen extends StatelessWidget {
  final bool isDark;
  const LaranganHajiScreen({super.key, this.isDark = false});
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemCount: laranganHajiMenuItems.length,
              itemBuilder: (context, index) {
                final item = laranganHajiMenuItems[index];
