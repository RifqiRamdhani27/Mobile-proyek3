...
final List<Map<String, String>> pengertianHajiMenuItems = [
  {
    "title": "Penjelasan Haji",
    "image": "assets/images/penjelasan_haji.png",
    "route": "/pengertian_haji/penjelasan_haji",
  },
  {
    "title": "Hukum Haji",
    "image": "assets/images/hukum.png",
    "route": "/pengertian_haji/hukum_haji",
  },
  {
    "title": "Syarat Wajib Haji",
    "image": "assets/images/syarat.png",
    "route": "/pengertian_haji/syarat_wajib_haji",
  },
  {
    "title": "Syarat Sah Haji",
    "image": "assets/images/syarat_sah.png",
    "route": "/pengertian_haji/syarat_sah_haji",
  },
];
                ...
                return GestureDetector(
                  onTap: () {
                    ...
                    final screenMap = <String, Widget>{
                      '/pengertian_haji/penjelasan_haji': PenjelasanHajiScreen(
                        isDark: isDark,
                      ),
                      '/pengertian_haji/hukum_haji': HukumHajiScreen(
                        isDark: isDark,
                      ),
                      '/pengertian_haji/syarat_wajib_haji':
                          SyaratWajibHajiScreen(isDark: isDark),
                      '/pengertian_haji/syarat_sah_haji': SyaratSahHajiScreen(
                        isDark: isDark,
                      ),
                    };
