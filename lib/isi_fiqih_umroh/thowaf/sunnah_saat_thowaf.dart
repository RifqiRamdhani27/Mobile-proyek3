...
class SunnahSaatThowafScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final items = [
      ...
      {
        'title': 'Membaca doa antara Rukun Yamani dan Hajar Aswad:',
        'desc': '"Rabbana atina fid-dunya hasanah…"',
      },
      {
        'title': 'Bagi laki-laki melakukan idhthiba\'',
        'desc': 'Membuka bahu kanan saat thowaf umroh.',
      },
      {
        'title': 'Melakukan raml',
        'desc': 'Lari kecil pada 3 putaran pertama bagi laki-laki.',
      },
    ];
