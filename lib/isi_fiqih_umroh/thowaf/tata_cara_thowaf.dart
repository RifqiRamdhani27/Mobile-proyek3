...
class TataCaraThowafScreen extends StatelessWidget {
  final bool isDark;
  const TataCaraThowafScreen({super.key, this.isDark = false});
  ...
  Widget build(BuildContext context) {
    ...
    final steps = [
      'Suci dari hadas (berwudhu)',
      'Menutup aurat',
      'Niat dalam hati',
      'Memulai dari Hajar Aswad',
      'Mengelilingi Ka\'bah 7 putaran berlawanan arah jarum jam',
      'Membaca doa dan dzikir selama thowaf',
      'Setelah selesai, shalat 2 rakaat di belakang Makam Ibrahim (jika memungkinkan)',
    ];
