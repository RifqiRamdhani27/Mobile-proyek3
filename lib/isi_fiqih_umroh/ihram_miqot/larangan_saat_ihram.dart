...
class LaranganSaatIhramScreen extends StatelessWidget {
  final bool isDark;
  const LaranganSaatIhramScreen({super.key, this.isDark = false});
  ...
  Widget build(BuildContext context) {
    ...
    final laranganPerempuan = ['Tidak memakai cadar dan sarung tangan'];
