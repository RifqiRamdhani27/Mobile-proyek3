...
class PenjelasanSaiScreen extends StatelessWidget {
  final bool isDark;
  const PenjelasanSaiScreen({super.key, this.isDark = false});
  ...
  Widget build(BuildContext context) {
    ...
    final urutan = [
      'Dimulai dari Shafa',
      'Berakhir di Marwah',
      'Satu kali perjalanan dihitung dari satu bukit ke bukit lainnya',
    ];
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text(
                    "Sa'i adalah bentuk ibadah yang menunjukkan usaha dan ketekunan dalam mencari pertolongan Allah.",
                    style: TextStyle(fontSize: 15, height: 1.6, color: textClr),
                    textAlign: TextAlign.justify,
                  ),
