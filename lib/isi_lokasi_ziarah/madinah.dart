...
const _lokasiMadinah = [
  {
    ...
    'desc':
        'Masjid kedua yang dibangun Rasulullah ﷺ. Di dalamnya terdapat makam Nabi Muhammad ﷺ, Abu Bakar, dan Umar bin Khattab. Shalat di sini senilai 1.000 kali lipat dibanding masjid lain.',
  },
  {
    'nama': 'Raudhah (Taman Surga)',
    'lokasi': 'Di dalam Masjid Nabawi',
    'desc':
        'Area antara mimbar dan makam Rasulullah ﷺ yang disebut sebagai taman surga. Salah satu tempat mustajab untuk berdoa. Kunjungan perlu jadwal via aplikasi Nusuk.',
  },
  {
    'nama': 'Pemakaman Baqi (Jannatul Baqi)',
    'lokasi': 'Sisi timur Masjid Nabawi',
    'desc':
        'Pemakaman ribuan sahabat Nabi, termasuk istri-istri beliau seperti Aisyah r.a., anak, dan cucu beliau. Suasana sangat khidmat dan penuh sejarah.',
  },
  {
    'nama': 'Masjid Quba',
    'lokasi': '±5 km dari Masjid Nabawi',
    'desc':
        'Masjid pertama yang dibangun Rasulullah ﷺ setelah hijrah. Shalat 2 rakaat di sini pahalanya setara umroh. Disebut dalam QS. At-Taubah: 108.',
  },
  {
    'nama': 'Jabal Uhud & Makam Syuhada',
    'lokasi': '±5 km utara Madinah',
    'desc':
        'Lokasi Perang Uhud. Di sini dimakamkan para syuhada termasuk Hamzah bin Abdul Muttalib, paman Nabi. Tempat ziarah yang penuh makna pengorbanan.',
  },
  {
    'nama': 'Masjid Qiblatain',
    'lokasi': 'Barat laut Madinah',
    'desc':
        "Masjid dengan dua arah kiblat — saksi sejarah perpindahan kiblat dari Masjidil Aqsa ke Ka'bah. Simbol ketaatan kepada perintah Allah.",
  },
  {
    'nama': 'Masjid Bir Ali (Masjid Miqat)',
    'lokasi': '±9 km dari Masjid Nabawi',
    'desc':
        'Miqat bagi jamaah yang berangkat dari Madinah menuju Mekkah untuk berihram. Dikenal juga sebagai Masjid Abyar Ali.',
  },
  {
    'nama': 'Wadi Jin (Bukit Magnet)',
    'lokasi': 'Luar kota Madinah',
    'desc':
        'Bukit dengan medan magnet unik. Kendaraan yang dimatikan mesinnya akan bergerak sendiri seolah tertarik. Fenomena alam yang menakjubkan.',
  },
];
