    ...
    final dzikir = [
      {
        ...
        'arti':
            'Ya Allah Tuhan manusia, hilangkanlah penyakit ini, sembuhkanlah. Engkaulah Maha Penyembuh. Tidak ada kesembuhan kecuali kesembuhan dari-Mu, kesembuhan yang tidak meninggalkan rasa sakit.',
      ...
      },
      {
        ...
        'arti':
            'Ya Allah, aku berlindung kepada-Mu dari penyakit belang, gila, kusta, dan penyakit-penyakit buruk lainnya.',
        'sumber': '(HR. Abu Dawud)',
        'catatan': null,
      },
      {
        ...
        'arab':
            'اللّهُمَّ إِنِّي أَسْأَلُكَ الْعَفْوَ وَالْعَافِيَةَ فِي الدُّنْيَا وَالْآخِرَةِ',
        'arti':
            'Ya Allah, aku memohon ampunan dan kesehatan (keselamatan) di dunia dan akhirat.',
        'sumber': '(HR. Tirmidzi)',
